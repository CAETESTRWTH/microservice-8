 ...
 * 8 - Test Class
 *
 * This class provides a basic testing framework for the microservice 8. It was
...
public class PoemsTest {
  ...
  private static final ServiceNameVersion testTemplateService = new ServiceNameVersion(Poems.class.getCanonicalName(),"0.1");

  private static final String mainPath = "poems";
  ...
  public void testgetPoems() {
    ...
    try {
      ...
      ClientResponse result = c.sendRequest("GET", mainPath + "/poems", "",
        MediaType.TEXT_PLAIN, MediaType.APPLICATION_JSON, new HashMap<String,String>());
      assertTrue(true); // change here
      System.out.println("Result of 'testgetPoems': " + result.getResponse().trim());
    } catch (Exception e) {
      e.printStackTrace();
      fail("Exception: " + e);
    }
